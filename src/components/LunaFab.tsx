    ...
    <>
      <div className="fixed bottom-24 z-50 flex justify-end pointer-events-none" style={{ left: '50%', transform: 'translateX(-50%)', width: '100%', maxWidth: '430px', paddingRight: '1rem' }}>
        <button
          ...
          className="pointer-events-auto w-[68px] h-[68px] rounded-full flex items-center justify-center hover:scale-110 active:scale-95 transition-transform"
          style={{ filter: "drop-shadow(0 4px 12px rgba(140, 80, 160, 0.35))" }}
          aria-label="루나 챗봇 열기"
        >
          <img src={lunaMascot} alt="루나" className="w-[68px] h-[68px]" />
        </button>
      </div>
